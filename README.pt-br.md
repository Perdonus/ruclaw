...
Alternativamente, baixe o binário para sua plataforma na página de [GitHub Releases](https://github.com/Perdonus/ruclaw/releases).
...
Veja nosso [Roadmap da Comunidade](https://github.com/Perdonus/ruclaw/issues/988) e [CONTRIBUTING.md](CONTRIBUTING.md) para diretrizes.
