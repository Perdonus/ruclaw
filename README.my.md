...
Muat turun binari untuk platform anda dari halaman [GitHub Releases](https://github.com/Perdonus/ruclaw/releases).
...
Lihat [Peta Jalan Komuniti](https://github.com/Perdonus/ruclaw/issues/988) dan [CONTRIBUTING.md](CONTRIBUTING.md) untuk panduan.
