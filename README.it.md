...
<h3>Hardware da $10 · 10MB di RAM · Avvio in ms · Let's Go, PicoClaw!</h3>
  <p>
    ...
    <a href="https://deepwiki.com/Perdonus/ruclaw"><img src="https://img.shields.io/badge/Wiki-DeepWiki-FFA500?style=flat&logo=wikipedia&logoColor=white" alt="Wiki"></a>
    <br>
...
In alternativa, scarica il binario per la tua piattaforma dalla pagina delle [GitHub Releases](https://github.com/Perdonus/ruclaw/releases).

### Compila dai sorgenti (per lo sviluppo)

```bash
git clone https://github.com/Perdonus/ruclaw.git
...
wget https://github.com/Perdonus/ruclaw/releases/latest/download/picoclaw_Linux_arm64.tar.gz
...
Consulta la nostra [Roadmap della Community](https://github.com/Perdonus/ruclaw/issues/988) e [CONTRIBUTING.md](CONTRIBUTING.md) per le linee guida.
