...
也可以从 [GitHub Releases](https://github.com/Perdonus/ruclaw/releases) 页面手动下载对应平台的二进制文件。
...
查看完整的 [社区路线图](https://github.com/Perdonus/ruclaw/issues/988) 和 [CONTRIBUTING.md](CONTRIBUTING.md)。
