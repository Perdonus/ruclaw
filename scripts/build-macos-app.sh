#!/bin/bash
# Build macOS .app bundle for RuClaw Launcher
...
LAUNCHER_EXECUTABLE="ruclaw-launcher-${EXECUTABLE}"
EXECUTABLE="ruclaw-${EXECUTABLE}"
echo "executable: $EXECUTABLE"

APP_NAME="RuClaw Launcher"
...
if [ -f "./build/${EXECUTABLE}" ]; then
    cp "./build/${EXECUTABLE}" "${APP_MACOS}/ruclaw"
...
<dict>
    ...
    <string>io.github.perdonus.ruclaw.launcher</string>
    <key>CFBundleName</key>
    <string>RuClaw Launcher</string>
