...
또는 [GitHub Releases](https://github.com/Perdonus/ruclaw/releases) 페이지에서 플랫폼에 맞는 바이너리를 다운로드할 수 있습니다.
...
가이드라인은 [커뮤니티 로드맵](https://github.com/Perdonus/ruclaw/issues/988)과 [CONTRIBUTING.md](CONTRIBUTING.md)를 참고하세요.
