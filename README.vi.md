...
Ngoài ra, tải binary cho nền tảng của bạn từ trang [GitHub Releases](https://github.com/Perdonus/ruclaw/releases).
...
Xem [Lộ trình Cộng đồng](https://github.com/Perdonus/ruclaw/issues/988) và [CONTRIBUTING.md](CONTRIBUTING.md) để biết hướng dẫn.
