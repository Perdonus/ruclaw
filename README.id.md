...
Atau, unduh binary untuk platform Anda dari halaman [GitHub Releases](https://github.com/Perdonus/ruclaw/releases).
...
Lihat [Roadmap Komunitas](https://github.com/Perdonus/ruclaw/issues/988) dan [CONTRIBUTING.md](CONTRIBUTING.md) untuk panduan.
