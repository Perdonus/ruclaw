...
import (
    "github.com/Perdonus/ruclaw/pkg/bus"
    "github.com/Perdonus/ruclaw/pkg/channels"     // 引用父包
    "github.com/Perdonus/ruclaw/pkg/config"
    "github.com/Perdonus/ruclaw/pkg/identity"      // 新增
    "github.com/Perdonus/ruclaw/pkg/media"          // 新增（如需媒体）
)
```
...
import (
    _ "github.com/Perdonus/ruclaw/pkg/channels/telegram"   // 触发 init() 注册
    _ "github.com/Perdonus/ruclaw/pkg/channels/discord"
    _ "github.com/Perdonus/ruclaw/pkg/channels/your_new_channel"  // 新增
)
```
