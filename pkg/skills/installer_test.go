...
func TestParseGitHubRef(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			repo:         "Perdonus/ruclaw/skills/test",
			wantOwner:    "sipeed",
			wantRepoName: "picoclaw",
			wantRef:      "main",
		...
		},
		{
			...
			repo:         "https://github.com/Perdonus/ruclaw/tree/dev/skills/test",
			wantOwner:    "sipeed",
			wantRepoName: "picoclaw",
			wantRef:      "dev",
			wantSubPath:  "skills/test",
		},
		{
			...
			repo:         "https://github.com/Perdonus/ruclaw/blob/main/README.md",
			wantOwner:    "sipeed",
			wantRepoName: "picoclaw",
			wantRef:      "main",
		...
		},
		{
			...
			repo:         "https://github.com/Perdonus/ruclaw",
			wantOwner:    "sipeed",
			wantRepoName: "picoclaw",
			wantRef:      "main",
			wantSubPath:  "",
...
func TestSkillInstaller_InstallFromGitHub_SkillAlreadyExists(t *testing.T) {
	...
	err = installer.InstallFromGitHub(context.Background(), "Perdonus/ruclaw")
	if err == nil {
